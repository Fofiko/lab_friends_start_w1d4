...
class TestFriends < MiniTest::Test
  ...
  def test_getting_favourite_food__true
    result = likes_to_eat(@person2, "bread")
    assert_equal(true, result)
  end

  def test_getting_favourite_food__false
    result = likes_to_eat(@person2, "beef")
...
#
  ...
  def test_total_monies
    result = add_total_monies(@people)
